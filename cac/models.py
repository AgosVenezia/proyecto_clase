...
class Curso(models.Model):
    ...
    #portada = models.FileField(upload_to='imagenes/',null=True,verbose_name='Portada')
...
class Proyecto(models.Model):
    nombre = models.CharField(max_length=100,verbose_name='Nombre')
    # campo del tipo slug - string con guiones medio
    ...
    def save(self, *args, **kwargs):
        self.nombre_slug = slugify(self.nombre) #URL amigable
