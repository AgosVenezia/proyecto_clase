...
#from django.contrib.auth.models import UserAdmin, GroupAdmin
...
class EstudianteMAdmin(admin.ModelAdmin):
    list_display = ('dni_m','apellido_m','nombre_m') #el primero siempre es el clickeable
...
class CursoMAdmin(admin.ModelAdmin):
    ...
    #modificar el listado relacion OneToMany
...
#mi_admin.register(UserAdmin)
mi_admin.register(Group)
#mi_admin.register(GroupAdmin)
